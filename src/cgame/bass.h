...
#define BASS_CONFIG_NET_PREBUF		15
	...
	char	*
	BASSDEF( BASS_GetDeviceDescription )( DWORD device );
	...
	void	*
	BASSDEF( BASS_GetDSoundObject )( DWORD object );
	...
	char	*
	BASSDEF( BASS_MusicGetName )( HMUSIC handle );
	...
	void	*
	BASSDEF( BASS_SampleCreate )( DWORD length, DWORD freq, DWORD max, DWORD flags );
	...
	char	*
	BASSDEF( BASS_StreamGetTags )( HSTREAM handle, DWORD tags );
	DWORD BASSDEF ( BASS_StreamGetFilePosition ) ( HSTREAM handle, DWORD mode );
	char	*
	BASSDEF( BASS_RecordGetDeviceDescription )( DWORD device );
	...
	char	*
	BASSDEF( BASS_RecordGetInputName )( DWORD input );
