...
#ifdef __SUPREMACY__
#define POP_HUD_CHATWIDTH		280
#define POP_HUD_PMWIDTH			250
#define POP_HUD_COMPASS_X		640 - 128 - 15
#define POP_HUD_COMPASS_Y		15
#define POP_HUD_COMPASS_W		128
#define POP_HUD_COMPASS_H		128
#define POP_HUD_MAXPM			6
#define POP_HUD_MAXOBIT			5
#define POP_HUD_MISCFONTBIG		0.30f
#define POP_HUD_MISCFONTSMALL	0.22f
#define POP_HUD_MISCFONTTINY	0.18f
#define POP_HUD_DEFAULTFONTSIZE 0.16f
#define POP_HUD_DEFAULTFONT		cgs.media.tahoma16
#define POP_HUD_ICONWIDTH		16
#define POP_HUD_ICONHEIGHT		16
#define POP_HUD_BORDERPADDING	5
...
typedef struct
{
	...
	int			painAnimLegs;
	int			lightningFiring;
	vec3_t		ejectBrassCasingOrigin; // moved here
	...
	int			weaponFireTime;
	qboolean	turretRotating;
	int			turretStopTime;
	float		lastSlope;
	qboolean	lastSlopeInit;
	int			lastSlopeTime;
	int			vehicleIgniteTime;
...
#define MAX_NEW_PARTICLES			MAX_PARTICLE_EJECTORS * 5
...
typedef struct baseParticleEjector_s
{
	...
	sfxHandle_t		soundNum;
	char			loopedSoundName[MAX_OSPATH];
	sfxHandle_t		loopedSoundNum;
...
typedef struct clientInfo_s
{
	...
	int				headSkin;									// How about some variation ? :)
	int				headModel;
} clientInfo_t;
...
typedef struct centity_s
{
...
#ifdef __NPC__
	clientInfo_t	NPC_client;
#endif
	int				last_altfire_time;
#ifdef __SUPREMACY__
	int				om_flag_frame;
#endif //__SUPREMACY__
#ifdef __PARTICLE_SYSTEM__
	...
	qboolean			valid;
	qboolean			oldValid;
	particleSystem_t	*entityPS2;
	particleSystem_t	*entityPS3;
	particleSystem_t	*entityPS4;
	particleSystem_t	*entityPS5;
	particleSystem_t	*flameTrailPS;

	// End New Particle System...
#endif //__PARTICLE_SYSTEM__
} centity_t;
...
void				CG_SetParticleSystemParentParticle ( particleSystem_t *ps, new_particle_t *p );
...
void				CG_AddNewParticles ( void );
void				CG_ParticleSystemEntity ( centity_t *cent );
void				CG_DestroyAllEntityParticles ( centity_t *cent );
...
typedef enum
{
	...
	W_PART_6,
	W_PART_7,
	W_PART_8,// jaquboss added few more
	W_PART_9,
	W_PART_10,
	W_MAX_PARTS
} barrelType_t;
...
/*		qhandle_t	soldierskin[3];		
		qhandle_t	medicskin[3];	
		qhandle_t	engineerskin[3];
		qhandle_t	fieldopsskin[3];	
		qhandle_t	covertopsskin[3];*/
	qboolean	useCharacterSkin;
} partModel_t;
...
//	qhandle_t		ammoIcon;
	qhandle_t		brassModel;			// Jaquboss
	vec3_t			ADSPos;				// Jaquboss
...
typedef struct
{
	...
	vec3_t				ScopeViewAngles;

	// zoom key
	qboolean			zoomed;
	qboolean			zoomedBinoc;
	qboolean			zoomedSniper;

	//	qboolean	aiming; // client is using ironsights
...
typedef struct
{
	...
	qhandle_t	browningHintShader;
	qhandle_t	aagunTagmodel;
	qhandle_t	aagunHintShader;
	...
	qhandle_t	commandCentreMapShader_UNKNOWN;
...
#define NUMTANKS	2						// just jagdenpanzer and churchill now
	qhandle_t	tankModel[NUMTANKS];		// jaquboss
	qhandle_t	tankTracksModel[NUMTANKS];	// jaquboss
	qhandle_t	tankTurretModel[NUMTANKS];
	qhandle_t	tankBarrelModel[NUMTANKS];
	qhandle_t	tankFlashModel;
	qhandle_t	tankShader[4];
	qhandle_t	thirdPersonBinocModel;		//----(SA)	added
	qhandle_t	flamethrowerBackModel;
	qhandle_t	gmask;
	qhandle_t	BacksModel;
	qhandle_t	BacksModel2;
	qhandle_t	radiomodel;
	qhandle_t	gibModels[MAX_GIB_MODELS];
	qhandle_t	bulletload;
	qhandle_t	bulletload2;
	qhandle_t	bulletload3;
	qhandle_t	redflag;
	qhandle_t	blueflag;
	qhandle_t	mortarload[12];
	...
	qhandle_t	spotLightBaseModel;		//----(UQ1)	added
	qhandle_t	spotLightLightModel;	//----(UQ1)	added
	qhandle_t	spotLightLightModelBroke;	//----(UQ1)	added

	qhandle_t	bulletParticleTrailShader;
	qhandle_t	smokeParticleShader;
	qhandle_t	panzerfaustsmokeParticleShader;
	...
	sfxHandle_t countFight_axis;
	sfxHandle_t countFight_allies;
	sfxHandle_t sfx_alliespain1;
	sfxHandle_t sfx_alliespain2;
	sfxHandle_t sfx_alliespain3;
	sfxHandle_t sfx_alliespain4;
	sfxHandle_t sfx_axispain1;
	sfxHandle_t sfx_axispain2;
	sfxHandle_t sfx_axispain3;
	sfxHandle_t sfx_axispain4;
	sfxHandle_t hitsound;
	sfxHandle_t hitteammate;
	...
	sfxHandle_t weaponbounce;
	qhandle_t	cursor;
	qhandle_t	selectCursor;
	qhandle_t	sizeCursor;
	sfxHandle_t tankMoveSound;
	sfxHandle_t tankIdleSound;
	sfxHandle_t tankStartSound;
	sfxHandle_t tankStopSound;
	sfxHandle_t tankTurretSound;
	sfxHandle_t tankTurretEndSound;
	sfxHandle_t tankFireSound;
	sfxHandle_t pushPlayer;
	...
	sfxHandle_t sndMedicCall_axis[3];
	sfxHandle_t sndMedicCall_allies[3];
	sfxHandle_t sfx_flakimpact;
	sfxHandle_t flagsound;
	sfxHandle_t flagsound_allies;
	sfxHandle_t flagsound_axis;
	...
	qhandle_t	medicIcon;
	sfxHandle_t	hWeaponSnd;
	sfxHandle_t	hflakWeaponSnd;
	sfxHandle_t	hWeaponEchoSnd;
	sfxHandle_t	hWeaponHeatSnd;
	sfxHandle_t	hWeaponEchoSnd_3;
	sfxHandle_t	hWeaponSnd_2;
	sfxHandle_t	hWeaponEchoSnd_2;
	sfxHandle_t	hWeaponHeatSnd_2;
	sfxHandle_t	mg42loop;
	sfxHandle_t	browningloop;
	sfxHandle_t	deathloop;
	sfxHandle_t	mg42calm;
	sfxHandle_t	browningcalm;
	sfxHandle_t	chatsound;

	//	qhandle_t	hflakWeaponSnd;
	qhandle_t	hSearchLight;
//#ifdef __NPC__
	qhandle_t	hPropeller;
...
//#endif //__NPC__
	...
	fontInfo_t	tahoma16;					// Actually using limbofont1
	...
	qhandle_t	limboWeaponCard3;			// jaquboss
...
#ifdef __SUPREMACY__
	qhandle_t	hudFlagAxisIcon;
	qhandle_t	hudFlagAlliesIcon;
	qhandle_t	hudFlagNeutralIcon;
#endif //__SUPREMACY__
...
typedef struct
{
	...
	bg_character_t		*gameCharacters[MAX_GAME_CHARACTERS /*MAX_CHARACTERS*/ ];
...
#else //__NPC__
	clientInfo_t		clientinfo[MAX_GENTITIES];
#endif //__NPC__
...
//extern	vmCvar_t		cg_nobipodmove;
extern vmCvar_t		cg_hunkCheck;
extern vmCvar_t		cg_crosshair_allowed;
...
extern vmCvar_t		cg_gun_pullback;
extern vmCvar_t		cg_swingSpeed;
extern vmCvar_t		cg_shadows;
extern vmCvar_t		cg_gibs;
extern vmCvar_t		cg_drawFrags;
extern vmCvar_t		cg_draw2D;
extern vmCvar_t		cg_compassTolerance;
extern vmCvar_t		cg_drawFPS;
extern vmCvar_t		cg_drawSnapshot;
extern vmCvar_t		cg_drawCrosshair;
extern vmCvar_t		cg_draw2dironsights;
...
extern vmCvar_t		cg_crosshairX_thirdperson;
extern vmCvar_t		cg_crosshairY_thirdperson;
extern vmCvar_t		cg_crosshairSize;
extern vmCvar_t		cg_crosshairHealth;
extern vmCvar_t		cg_drawStatus;
extern vmCvar_t		cg_drawAltHud;
...
extern vmCvar_t		cg_nopredictPing;
extern vmCvar_t		cg_nopredict;
extern vmCvar_t		cg_noPlayerAnims;
extern vmCvar_t		cg_showmiss;
extern vmCvar_t		cg_footsteps;
extern vmCvar_t		cg_markTime;
extern vmCvar_t		cg_markdistance;
extern vmCvar_t		cg_brassTime;
extern vmCvar_t		cg_gun_frame;
extern vmCvar_t		cg_gun_realisticposition;


extern vmCvar_t		CG_FlashBlend; // unique1's quakelike dlights

//extern	vmCvar_t		cg_playerLitMode;
extern vmCvar_t		cg_dynamicLight;
extern vmCvar_t		cg_gun_x;
extern vmCvar_t		cg_gun_y;
extern vmCvar_t		cg_gun_z;
extern vmCvar_t		cg_drawGun;
extern vmCvar_t		cg_shadowPlanes;
extern vmCvar_t		cg_draw3DlimboWeapons;
extern vmCvar_t		cg_bigLimbo;
extern vmCvar_t		cg_n1x;
extern vmCvar_t		cg_n1a;
extern vmCvar_t		cg_n2x;
extern vmCvar_t		cg_n2a;
extern vmCvar_t		cg_myHeadSkin;
extern vmCvar_t		cg_myHeadModel;
extern vmCvar_t		cg_drawstance;
...
extern vmCvar_t		cg_3rdPersonRange;
extern vmCvar_t		cg_3rdPersonAngle;
extern vmCvar_t		cg_3rdPersonFocus;
extern vmCvar_t		cg_3rdPerson;

//extern	vmCvar_t		cg_thirdPerson_allowed;
//extern	vmCvar_t		cg_thirdPerson_follow;
extern vmCvar_t		cg_firstPerson;
extern vmCvar_t		cg_snoopers;
extern vmCvar_t		cg_3rdPerson_maxrange;
extern vmCvar_t		cg_3rdPerson_maxangle;
extern vmCvar_t		cg_stereoSeparation;
extern vmCvar_t		cg_lagometer;
extern vmCvar_t		cg_hitsound_allowed;
extern vmCvar_t		cg_hitsound;
extern vmCvar_t		cg_goatsound;

//extern	vmCvar_t		cg_debugtags;
#ifdef ALLOW_GSYNC
...
extern vmCvar_t		cg_corona_flash;
...
extern vmCvar_t		cg_renderToTexture;
...
extern vmCvar_t		cg_3rdPerson_allowed;
//extern vmCvar_t		cg_3rdPerson_follow;	// Kamikazee: use cg_3rdPerson
extern vmCvar_t		cg_realmedic;
extern vmCvar_t		cg_noCapsule;
extern vmCvar_t		cg_nohud;

//extern vmCvar_t	cg_debugBullets;
extern vmCvar_t		cg_AutoReloads;

// jpw
//extern vmCvar_t	cg_height;
//extern vmCvar_t	cg_snow;
//extern vmCvar_t	cg_rain;
extern vmCvar_t		cg_movespeed;
extern vmCvar_t		cg_breathVolume;					// jaquboss
extern vmCvar_t		cg_limboMusic;						// jaquboss
...
extern vmCvar_t		cg_drawAltCrosshair;
...
extern vmCvar_t		cg_envmapupdate;
extern vmCvar_t		cg_blur;
extern vmCvar_t		cg_envmap_fov;
...
extern vmCvar_t		cg_camo_axis;
extern vmCvar_t		cg_camo_allies;
extern vmCvar_t		cg_nazi;
#ifdef __PORTAL_SCOPE__
extern vmCvar_t		cg_portalScope;
#endif
//
//
// cg_main.c
...
//void CG_ToggleThirdperson( void );
...
void				CG_ColorForStamina ( vec4_t scolor );
...
void				CG_Text_Paint_Centred_Ext
					(
						float		x,
						float		y,
						float		scalex,
...
void				CG_PainEvent ( centity_t *cent, int health, qboolean crouching, team_t team );
void				CG_ExertSound ( int sprintTime, int Time );
...
void				CG_Smokey ( int clientNum, vec3_t origin, vec3_t dir );							//	(SA) modified to send missilehitwall surface parameters
...
void				CG_RailTrail ( vec3_t color, vec3_t start, vec3_t end, int type );				//----(SA)	added 'type'
void				CG_RailTrail2 ( vec3_t color, vec3_t start, vec3_t end );
void				CG_GrappleTrail ( centity_t *ent, const weaponInfo_t *wi );
void				CG_AddViewWeapon ( playerState_t *ps );
void				CG_AddPlayerWeapon ( refEntity_t *parent, playerState_t *ps, centity_t *cent, qboolean UI );
...
void				CG_ParticleImpactSmokePuffExtended
					(
						...
						float		alpha,
						float		size
					);															// (SA) so I can add more parameters without screwing up the one that's there
// RTCW Single Player Version...
void				CG_ParticleImpactSmokePuffExtendedRTCW (qhandle_t pshader, vec3_t origin, vec3_t dir, int radius, int lifetime, int vel, int acc, int maxroll, float alpha);
...
localEntity_t		*CG_MakeExplosion
					(
						vec3_t		origin,
						vec3_t		dir,
						qhandle_t	hModel,
...
// UQ1: RTCW Version...
void CG_SpotlightRTCW(centity_t *cent, float *color, vec3_t realstart, vec3_t lightDir, int segs, float range, int startWidth, float coneAngle, int flags);
...
void trap_S_StartLocalSoundVControll ( sfxHandle_t sfx, int channelNum, int volume );
...
#define CPri( x ) \
	CG_CenterPrint( CG_LocalizeServerCommand( x), SCREEN_HEIGHT - (SCREEN_HEIGHT * 0.2), SMALLCHAR_WIDTH );
...
void						CG_RegisterHeadSkins ( void );
void						CG_RegisterHeadModels ( void );
...
qboolean					CG_LimboPanel_Hat_KeyDown ( panel_button_t *button, int key );
...
qboolean					CG_LimboPanel_Enlarge_KeyDown ( panel_button_t *button, int key );
...
void						CG_LimboPanel_Setup ( qboolean music );
...
#define CC_2D_W		352
#define CC_2D_H		352
void			CG_DrawLimboGun ( rectDef_t *rect, float yaw, float pitch, weaponInfo_t *weapon );
void			CG_DrawPlayerHead
				(
					rectDef_t			*rect,
					bg_character_t		*character,
...
void			CG_LoadingItem ( panel_button_t *button );
...
// Jaquboss custom player looks
typedef struct headModels_s
{
	qhandle_t	model;
} headModels_t;
typedef struct headSkins_s
{
	qhandle_t	skin;
} headSkins_t;
headSkins_t		headSkinsAxis[MAX_CUSTOM_SKINS];
headSkins_t		headSkinsAllies[MAX_CUSTOM_SKINS];
headModels_t	headModelsAxis[MAX_CUSTOM_MODELS];
headModels_t	headModelsAllies[MAX_CUSTOM_MODELS];

// UQ1: Added useful TAG procedures... cg_tags.c
qboolean		CG_TagValid ( refEntity_t refent, char *tagname );
...
#endif //__NPC__
bg_character_t	*CG_GetCharacter ( int team, int classNum );
