...
/* */
void
CG_PanelButton_RenderEdit ( panel_button_t *button )
{
...
/* */
qboolean
CG_PanelButton_EditClick ( panel_button_t *button, int key )
{
	if ( key == K_MOUSE1 )
	{
...
/* */
qboolean
CG_PanelButtonsKeyEvent ( int key, qboolean down, panel_button_t **buttons )
{
...
/* */
void
CG_PanelButtonsSetup ( panel_button_t **buttons )
{
	panel_button_t	*button;
	for ( ; *buttons; buttons++ )
	{
...
/* */
void
CG_PanelButtonsRender ( panel_button_t **buttons )
{
	panel_button_t	*button;
	for ( ; *buttons; buttons++ )
	{
...
/* */
void
CG_PanelButtonsRender_Text ( panel_button_t *button )
{
	if ( !button->font )
	{
		return;
...
/* */
void
CG_PanelButtonsRender_Img ( panel_button_t *button )
{
...
/* */
panel_button_t *
CG_PanelButtons_GetFocusButton ( void )
{
...
/* */
void
CG_PanelButtons_SetFocusButton ( panel_button_t *button )
{
