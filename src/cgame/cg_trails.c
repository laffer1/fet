...
*/
trailJunc_t *
CG_SpawnTrailJunc ( trailJunc_t *headJunc )
{
	trailJunc_t *j;
	if ( !freeTrails )
	{
...
*/
void
CG_FreeTrailJunc ( trailJunc_t *junc )
{
...
/* */
void
CG_AddTrailToScene ( trailJunc_t *trail, int iteration, int numJuncs )
{
