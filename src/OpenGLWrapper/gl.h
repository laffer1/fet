 ...
 */
	...
	GLAPI void GLAPIENTRY		glDrawPixels
								(
									GLsizei			width,
									GLsizei			height,
									GLenum			format,
 ...
 */
	...
	GLAPI void GLAPIENTRY		glGetTexImage
								(
									GLenum	target,
									GLint	level,
									GLenum	format,
	...
	GLAPI void GLAPIENTRY		glCopyTexSubImage1D
								(
									GLenum	target,
									GLint	level,
									GLint	xoffset,
 ...
 */
	...
	/* 1.2 functions */
	GLAPI void GLAPIENTRY		glDrawRangeElements
								(
									GLenum			mode,
									GLuint			start,
									GLuint			end,
	...
	GLAPI void GLAPIENTRY		glTexSubImage3D
								(
									GLenum			target,
									GLint			level,
									GLint			xoffset,
	...
	GLAPI void GLAPIENTRY		glCopyTexSubImage3D
								(
									GLenum	target,
									GLint	level,
									GLint	xoffset,
	...
	GLAPI void GLAPIENTRY		glColorTable
								(
									GLenum			target,
									GLenum			internalformat,
									GLsizei			width,
	...
	GLAPI void GLAPIENTRY		glColorSubTable
								(
									GLenum			target,
									GLsizei			start,
									GLsizei			count,
	...
	GLAPI void GLAPIENTRY		glCopyColorTable
								(
									GLenum	target,
									GLenum	internalformat,
									GLint	x,
	...
	GLAPI void GLAPIENTRY		glGetHistogram
								(
									GLenum		target,
									GLboolean	reset,
									GLenum		format,
	...
	GLAPI void GLAPIENTRY		glGetMinmax
								(
									GLenum		target,
									GLboolean	reset,
									GLenum		format,
	...
	GLAPI void GLAPIENTRY		glConvolutionFilter1D
								(
									GLenum			target,
									GLenum			internalformat,
									GLsizei			width,
	...
	GLAPI void GLAPIENTRY		glConvolutionFilter2D
								(
									GLenum			target,
									GLenum			internalformat,
									GLsizei			width,
	...
	GLAPI void GLAPIENTRY		glCopyConvolutionFilter1D
								(
									GLenum	target,
									GLenum	internalformat,
									GLint	x,
	...
	GLAPI void GLAPIENTRY		glCopyConvolutionFilter2D
								(
									GLenum	target,
									GLenum	internalformat,
									GLint	x,
	...
	GLAPI void GLAPIENTRY		glSeparableFilter2D
								(
									GLenum			target,
									GLenum			internalformat,
									GLsizei			width,
	...
	GLAPI void GLAPIENTRY		glGetSeparableFilter
								(
									GLenum	target,
									GLenum	format,
									GLenum	type,
