...
{
	{ PC_SOLDIER, "allied/soldier.char", "ui/assets/mp_gun_blue.tga", "ui/assets/mp_arrow_blue.tga", {
#ifdef NWEAPS
			WP_BAR,
#endif
			WP_THOMPSON, WP_30CAL, WP_FLAMETHROWER, WP_PANZERFAUST, WP_MORTAR, WP_M1GARAND }, },
	{ PC_MEDIC, "allied/medic.char", "ui/assets/mp_health_blue.tga", "ui/assets/mp_arrow_blue.tga", { WP_THOMPSON,
				WP_M1GARAND, }, },
	{ PC_ENGINEER, "allied/engineer.char", "ui/assets/mp_wrench_blue.tga", "ui/assets/mp_arrow_blue.tga", { WP_THOMPSON,
				WP_CARBINE, WP_M1GARAND, }, },
	{ PC_FIELDOPS, "allied/fieldops.char", "ui/assets/mp_ammo_blue.tga", "ui/assets/mp_arrow_blue.tga", { WP_THOMPSON,
				WP_M1GARAND, }, },
	{ PC_COVERTOPS, "allied/cvops.char", "ui/assets/mp_spy_blue.tga", "ui/assets/mp_arrow_blue.tga", { WP_STEN, WP_FG42,
				WP_GARAND, }, },
};
bg_playerclass_t	bg_axis_playerclasses[NUM_PLAYER_CLASSES] =
{
	{ PC_SOLDIER, "axis/soldier.char", "ui/assets/mp_gun_red.tga", "ui/assets/mp_arrow_red.tga", {
#ifdef NWEAPS
			WP_MP44,
#endif
			WP_MP40, WP_MOBILE_MG42, WP_FLAMETHROWER, WP_PANZERFAUST, WP_MORTAR, WP_G43, }, },
	{ PC_MEDIC, "axis/medic.char", "ui/assets/mp_health_red.tga", "ui/assets/mp_arrow_red.tga", { WP_MP40, WP_G43, }, },
	{ PC_ENGINEER, "axis/engineer.char", "ui/assets/mp_wrench_red.tga", "ui/assets/mp_arrow_red.tga", { WP_MP40,
				WP_KAR98, WP_G43, }, },
	{ PC_FIELDOPS, "axis/fieldops.char", "ui/assets/mp_ammo_red.tga", "ui/assets/mp_arrow_red.tga", { WP_MP40,
				WP_G43, }, },
	{ PC_COVERTOPS, "axis/cvops.char", "ui/assets/mp_spy_red.tga", "ui/assets/mp_arrow_red.tga", { WP_STEN, WP_FG42,
				WP_K43, }, },
};
...
/* */
bg_playerclass_t *
BG_PlayerClassForPlayerState ( playerState_t *ps )
{
...
/* */
qboolean
BG_ClassHasWeapon ( bg_playerclass_t *classInfo, weapon_t weap )
{
	int i;
	if ( !weap )
	{
...
/* */
qboolean
BG_WeaponIsPrimaryForClassAndTeam ( int classnum, team_t team, weapon_t weapon )
{
...
/* */
const char *
BG_ShortClassnameForNumber ( int classNum )
{
	switch ( classNum )
	{
		case PC_SOLDIER:
...
/* */
const char *
BG_ClassnameForNumber ( int classNum )
{
	switch ( classNum )
	{
		case PC_SOLDIER:
...
/* */
const char *
BG_ClassLetterForNumber ( int classNum )
{
	switch ( classNum )
	{
		case PC_SOLDIER:
...
/* */
int
BG_ClassTextToClass ( char *token )
{
...
/* */
skillType_t
BG_ClassSkillForClass ( int classnum )
{
