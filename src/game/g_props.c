...
/* */
void
moveit ( gentity_t *ent, float yaw, float dist )
{
	vec3_t	move;
	vec3_t	origin;
	trace_t tr;
...
/* */
void
touch_props_box_32 ( gentity_t *self, gentity_t *other, trace_t *trace )
{
	float	ratio;
	vec3_t	v;
...
*/
void
SP_props_box_32 ( gentity_t *self )
{
...
/* */
void
touch_props_box_48 ( gentity_t *self, gentity_t *other, trace_t *trace )
{
	float	ratio;
	vec3_t	v;
...
*/
void
SP_props_box_48 ( gentity_t *self )
{
...
/* */
void
touch_props_box_64 ( gentity_t *self, gentity_t *other, trace_t *trace )
{
	float	ratio;
	vec3_t	v;
...
*/
void
SP_props_box_64 ( gentity_t *self )
{
...
*/
void
PGUNsparks_use ( gentity_t *ent, gentity_t *self, gentity_t *activator )
{
	gentity_t	*tent;
...
/* */
void
sparks_angles_think ( gentity_t *ent )
{
...
*/
void
SP_props_gunsparks ( gentity_t *ent )
{
	G_SetOrigin( ent, ent->s.origin );
	ent->r.svFlags = 0;
	ent->s.eType = ET_GENERAL;
...
*/
void
smokedust_use ( gentity_t *ent, gentity_t *self, gentity_t *activator )
{
	int			i;
	gentity_t	*tent;
	vec3_t		forward;
...
*/
void
dust_use ( gentity_t *ent, gentity_t *self, gentity_t *activator )
{
	gentity_t	*tent;
	vec3_t		forward;
	if ( ent->target )
...
/* */
void
dust_angles_think ( gentity_t *ent )
{
	gentity_t	*target;
	vec3_t		vec;
	target = G_FindByTargetname( NULL, ent->target );
...
/* */
void
propExplosionLarge ( gentity_t *ent )
{
	gentity_t	*bolt;
	bolt = G_Spawn();
...
/* */
void
props_bench_think ( gentity_t *ent )
{
	ent->s.frame++;
	if ( ent->s.frame < 28 )
	{
...
/* */
void
props_bench_die ( gentity_t *ent, gentity_t *inflictor, gentity_t *attacker, int damage, int mod )
{
...
/* */
void
props_radio_die ( gentity_t *ent, gentity_t *inflictor, gentity_t *attacker, int damage, int mod )
{
	propExplosion( ent );
	ent->takedamage = qfalse;
	G_UseTargets( ent, NULL );
...
/* */
void
props_radio_dieSEVEN ( gentity_t *ent, gentity_t *inflictor, gentity_t *attacker, int damage, int mod )
{
	int i;
	propExplosion( ent );
	for ( i = 0; i < 20; i++ )
...
*/
void
SP_Props_RadioSEVEN ( gentity_t *ent )
{
	if ( !ent->model )
	{
		G_Printf( S_COLOR_RED "props_radio with NULL model\n" );
...
/* */
void
locker_tall_think ( gentity_t *ent )
{
	if ( ent->s.frame == 30 )
	{
		G_UseTargets( ent, NULL );
...
/* */
void
props_locker_tall_die ( gentity_t *ent, gentity_t *inflictor, gentity_t *attacker, int damage, int mod )
{
...
*/
void
SP_Props_Locker_Tall ( gentity_t *ent )
{
...
/* */
void
Just_Got_Thrown ( gentity_t *self )
{
	float		len;
	vec3_t		vec;
...
/* */
void
Props_TurnLightsOff ( gentity_t *self )
{
...
/* */
void
Props_Activated ( gentity_t *self )
{
	vec3_t		angles;
	vec3_t		dest;
...
/* */
void
Props_Chair_Think ( gentity_t *self )
{
	trace_t tr;
	if ( self->active )
	{
...
/* */
qboolean
Prop_Touch ( gentity_t *self, gentity_t *other, vec3_t v )
{
	vec3_t	forward;
	vec3_t	dest;
	vec3_t	angle;
...
/* */
void
Prop_Check_Ground ( gentity_t *self )
{
	vec3_t	mins, maxs;
	vec3_t	start, end;
	trace_t tr;
...
/* */
void
Props_Chair_Touch ( gentity_t *self, gentity_t *other, trace_t *trace )
{
	vec3_t		v;
	qboolean	has_moved;
	if ( !other->client )
...
/* */
void
Props_Chair_Animate ( gentity_t *ent )
{
	ent->touch = NULL;
...
void
Spawn_Shard ( gentity_t *ent, gentity_t *inflictor, int quantity, int type )
{
	gentity_t	*sfx;
	vec3_t		dir, start;
...
/* */
void
Prop_Break_Sound ( gentity_t *ent )
{
...
/* */
void
Props_Chair_Die ( gentity_t *ent, gentity_t *inflictor, gentity_t *attacker, int damage, int mod )
{
	int quantity;
	int type;
...
/* */
void
Props_Chair_Skyboxtouch ( gentity_t *ent )
{
	ent->think = G_FreeEntity;
}
...
/* */
void
SP_Props_ChairHiback ( gentity_t *ent )
{
	int mass;
...
/* */
void
SP_Props_ChairSide ( gentity_t *ent )
{
	int mass;
...
*/
void
SP_Props_ChateauChair ( gentity_t *ent )
{
	int mass;
	ent->delay = 0;					// inherits damage value
	if ( G_SpawnInt( "mass", "5", &mass) )
...
*/
void
SP_Props_ChairChat ( gentity_t *ent )
{
...
*/
void
SP_Props_ChairChatArm ( gentity_t *ent )
{
...
//----(SA)	end
void
Use_DamageInflictor ( gentity_t *ent, gentity_t *other, gentity_t *activator )
{
	gentity_t	*daent;
	daent = NULL;
...
*/
void
SP_Props_DamageInflictor ( gentity_t *ent )
{
	G_SetOrigin( ent, ent->s.origin );
	ent->r.svFlags = 0;
	ent->s.eType = ET_GENERAL;
...
*/
void
Use_Props_Shard_Generator ( gentity_t *ent, gentity_t *other, gentity_t *activator )
{
	int			quantity;
	int			type;
...
/* */
void
SP_props_shard_generator ( gentity_t *ent )
{
	G_SetOrigin( ent, ent->s.origin );
	ent->r.svFlags = 0;
	ent->s.eType = ET_GENERAL;
...
*/
void
SP_Props_Desklamp ( gentity_t *ent )
{
	int mass;
...
*/
void
Props_Barrel_Touch ( gentity_t *self, gentity_t *other, trace_t *trace )
{
...
/* */
void
Props_Barrel_Animate ( gentity_t *ent )
{
	float	ratio;
	vec3_t	v;
	if ( ent->s.frame == 14 )
...
/* */
void
OilParticles_think ( gentity_t *ent )
{
	gentity_t	*tent;
	gentity_t	*owner;
...
/* */
void
Delayed_Leak_Think ( gentity_t *ent )
{
	vec3_t		point;
	gentity_t	*tent;
	VectorCopy( ent->r.currentOrigin, point );
...
/* */
qboolean
validOilSlickSpawnPoint ( vec3_t point, gentity_t *ent )
{
	trace_t		tr;
	vec3_t		end;
	gentity_t	*traceEnt;
...
/* */
void
Props_Barrel_Pain ( gentity_t *ent, gentity_t *attacker, int damage, vec3_t point )
{
	if ( ent->health <= 0 )
	{
		return;
...
/* */
void
OilSlick_remove_think ( gentity_t *ent )
{
	gentity_t	*tent;
...
/* */
void
Props_Barrel_Die ( gentity_t *ent, gentity_t *inflictor, gentity_t *attacker, int damage, int mod )
{
	int		quantity;
	int		type;
	vec3_t	dir;
...
/* */
void
Props_Barrel_Think ( gentity_t *self )
{
	self->active = qfalse;
...
/* */
void
SP_Props_Flamebarrel ( gentity_t *ent )
{
	int mass;
	if ( ent->spawnflags & 4 )
	{
...
*/
void
touch_crate_64 ( gentity_t *self, gentity_t *other, trace_t *trace )
{
	float	ratio;
	vec3_t	v;
	if ( other->r.currentOrigin[2] > (self->r.currentOrigin[2] + 10 + 31) )
...
/* */
void
crate_die ( gentity_t *ent, gentity_t *inflictor, gentity_t *attacker, int damage, int mod )
{
	int quantity;
	int type;
	quantity = ent->wait;
...
//////////////////////////////////////////////
void
props_crate32x64_think ( gentity_t *ent )
{
	ent->s.frame++;
	if ( ent->s.frame < 17 )
	{
...
/* */
void
props_crate32x64_die ( gentity_t *ent, gentity_t *inflictor, gentity_t *attacker, int damage, int mod )
{
...
/* */
void
SP_Props_Crate32x64 ( gentity_t *ent )
{
	trap_SetBrushModel( ent, ent->model );
	InitProp( ent );
	if ( !ent->health )
...
*/
void
flippy_table_use ( gentity_t *ent, gentity_t *other, gentity_t *activator )
{
	qboolean	is_infront;
	gentity_t	*slave;
...
/* */
void
flippy_table_animate ( gentity_t *ent )
{
	return;
	if ( ent->s.frame == 9 )
	{
...
/* */
void
props_flippy_table_die ( gentity_t *ent, gentity_t *inflictor, gentity_t *attacker, int damage, int mod )
{
...
/* */
void
props_flippy_blocked ( gentity_t *ent, gentity_t *other )
{
	vec3_t	velocity;
	vec3_t	angles;
	vec3_t	kvel;
...
/* */
void
SP_Props_Flipping_Table ( gentity_t *ent )
{
	if ( !ent->model )
	{
...
*/
void
props_58x112tablew_think ( gentity_t *ent )
{
	ent->s.frame++;
	if ( ent->s.frame < 16 )
	{
...
/* */
void
props_58x112tablew_die ( gentity_t *ent, gentity_t *inflictor, gentity_t *attacker, int damage, int mod )
{
...
/* */
void
SP_Props_58x112tablew ( gentity_t *ent )
{
	trap_SetBrushModel( ent, ent->model );
	InitProp( ent );
	if ( !ent->health )
...
*/
void
props_castlebed_touch ( gentity_t *ent, gentity_t *other, trace_t *trace )
{
	if ( !other->client )
	{
		return;
...
/* */
void
props_castlebed_animate ( gentity_t *ent )
{
	ent->s.frame++;
	if ( ent->s.frame < 8 )
	{
...
/* */
void
props_castlebed_die ( gentity_t *ent, gentity_t *inflictor, gentity_t *attacker, int damage, int mod )
{
...
/* */
void
SP_props_castlebed ( gentity_t *ent )
{
	trap_SetBrushModel( ent, ent->model );
	InitProp( ent );
	if ( !ent->health )
...
*/
void
props_snowGenerator_think ( gentity_t *ent )
{
	gentity_t	*tent;
...
/* */
void
props_snowGenerator_use ( gentity_t *ent, gentity_t *other, gentity_t *activator )
{
	if ( !(ent->spawnflags & 1) )
	{
		ent->spawnflags |= 1;
...
/* */
void
SP_props_snowGenerator ( gentity_t *ent )
{
	vec3_t		center;
	gentity_t	*target = NULL;
	trap_SetBrushModel( ent, ent->model );
...
*/
void
props_decoration_animate ( gentity_t *ent )
{
	ent->s.frame++;
	ent->s.eType = ET_GENERAL;
...
/* */
void
props_decoration_death ( gentity_t *ent, gentity_t *inflictor, gentity_t *attacker, int damage, int mod )
{
	if ( !(ent->spawnflags & 8) )
	{
		ent->clipmask = 0;
...
/* */
void
Use_props_decoration ( gentity_t *ent, gentity_t *self, gentity_t *activator )
{
	if ( ent->spawnflags & 1 )
	{
		trap_LinkEntity( ent );
...
/* */
void
props_touch ( gentity_t *self, gentity_t *other, trace_t *trace )
{
...
/* */
void
SP_props_decoration ( gentity_t *ent )
{
	float		light;
	vec3_t		color;
	qboolean	lightSet, colorSet;
...
*/
void
SP_props_decorBRUSH ( gentity_t *self )
{
...
*/
void
SP_props_decor_Scale ( gentity_t *ent )
{
	float	scale[3] = { 1, 1, 1 };
	vec3_t	scalevec;
...
SP_skyportal ( gentity_t *ent )
{
	...
	trap_SetConfigstring( CS_SKYBOXORG, va( "%.2f %.2f %.2f %.1f %i %.2f %.2f %.2f %i %i", ent->s.origin[0],
						  ent->s.origin[1], ent->s.origin[2], fov_x, (int) isfog, fogv[0], fogv[1], fogv[2], fogn, fogf
						  ) );
...
*/
void
props_statue_blocked ( gentity_t *ent )
{
	trace_t		trace;
...
/* */
void
props_statue_animate ( gentity_t *ent )
{
...
/* */
void
props_statue_death ( gentity_t *ent, gentity_t *inflictor, gentity_t *attacker, int damage, int mod )
{
...
/* */
void
props_statue_touch ( gentity_t *self, gentity_t *other, trace_t *trace )
{
...
*/
void
SP_props_statueBRUSH ( gentity_t *self )
{
	trap_SetBrushModel( self, self->model );
...
*/
void
props_locker_endrattle ( gentity_t *ent )
{
	ent->s.frame = 0;	// idle
	ent->think = 0;
	ent->nextthink = 0;
...
/* */
void
props_locker_use ( gentity_t *ent, gentity_t *other, gentity_t *activator )
{
	if ( !ent->delay )
	{
...
/* */
void
props_locker_pain ( gentity_t *ent, gentity_t *attacker, int damage, vec3_t point )
{
...
/* */
void
props_locker_spawn_item ( gentity_t *ent )
{
	gitem_t		*item;
	gentity_t	*drop = NULL;
...
/* */
void
props_locker_mass ( gentity_t *ent )
{
	gentity_t	*tent;
	vec3_t		start;
	vec3_t		dir;
...
*/
void
props_locker_death ( gentity_t *ent, gentity_t *inflictor, gentity_t *attacker, int damage, int mod )
{
	ent->takedamage = qfalse;
...
/* */
void
SP_props_footlocker ( gentity_t *self )
{
	char	*type;
	char	*sound;
	char	*locked;
...
*/
void
props_flamethrower_think ( gentity_t *ent )
{
	vec3_t		vec, angles;
	gentity_t	*target = NULL;
...
/* */
void
props_flamethrower_use ( gentity_t *ent, gentity_t *other, gentity_t *activator )
{
	int rval;
	int rnd;
	if ( ent->spawnflags & 2 )
...
/* */
void
props_flamethrower_init ( gentity_t *ent )
{
	gentity_t	*target = NULL;
	vec3_t		vec;
	vec3_t		angles;
...
/* */
void
SP_props_flamethrower ( gentity_t *ent )
{
	char	*size;
	float	dsize;
