...
/* */
static animation_t *
BG_RAG_FindFreeAnimation ( qhandle_t mdxFile, const char *name )
{
	int i;
...
/* */
static qboolean
BG_RAG_ParseError ( int handle, char *format, ... )
{
	int			line;
	char		filename[128];
	va_list		argptr;
...
/* */
static qboolean
BG_RAG_ParseAnimation ( int handle, animation_t *animation )
{
	int i;
	animation->flags = 0;
...
/* */
static qboolean
BG_RAG_ParseAnimFile ( int handle, animModelInfo_t *animModelInfo )
{
	pc_token_t	token;
	qhandle_t	mdxFile;
...
/* */
qboolean
BG_R_RegisterAnimationGroup ( const char *filename, animModelInfo_t *animModelInfo )
{
	pc_token_t	token;
	int			handle;
