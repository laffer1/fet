...
g_serverEntity_t *
CreateServerEntity ( gentity_t *ent )
{
...
g_serverEntity_t *
FindServerEntity ( g_serverEntity_t *from, int fieldofs, char *match )
{
	char				*s;
...
void
InitServerEntitySetupFunc ( g_serverEntity_t *ent )
{
