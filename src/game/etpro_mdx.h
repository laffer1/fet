...
extern int			trap_R_LerpTag
					(
						orientation_t	*tag,		/*const*/
						grefEntity_t	*refent,
						const char		*tagName,
						int				startIndex
					);
...
extern void			mdx_body_position ( /*const*/ gentity_t *ent, /*const*/ grefEntity_t *refent, vec3_t org );
extern void			mdx_groin_position ( /*const*/ gentity_t *ent, /*const*/ grefEntity_t *refent, vec3_t org );
extern void			mdx_PlayerAngles
					(
						gentity_t	*ent,
						vec3_t		legsAngles,
						vec3_t		torsoAngles,
