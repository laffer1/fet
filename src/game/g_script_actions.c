...
/* */
qboolean
G_ScriptAction_SetModelFromBrushmodel ( gentity_t *ent, char *params )
{
	char		*pString, *token;
...
/* */
qboolean
G_ScriptAction_SetPosition ( gentity_t *ent, char *params )
{
...
/* */
qboolean
G_ScriptAction_SetAutoSpawn ( gentity_t *ent, char *params )
{
	char		*pString, *token;
...
/* */
qboolean
G_ScriptAction_ChangeModel ( gentity_t *ent, char *params )
{
	char	*pString, *token;
...
/* */
qboolean
G_ScriptAction_ShaderRemap ( gentity_t *ent, char *params )
{
	char	*pString, *token;
...
/* */
qboolean
G_ScriptAction_ShaderRemapFlush ( gentity_t *ent, char *params )
{
	trap_SetConfigstring( CS_SHADERSTATE, BuildShaderStateConfig() );
	return ( qtrue );
}
...
/* */
qboolean
G_ScriptAction_FollowPath ( gentity_t *ent, char *params )
{
	char		*pString, *token;
	float		speed;
...
/* */
qboolean
G_ScriptAction_AttatchToTrain ( gentity_t *ent, char *params )
{
	char		*pString;
	char		*token;
	gentity_t	*target;
...
/* */
qboolean
G_ScriptAction_FreezeAnimation ( gentity_t *ent, char *params )
{
	ent->s.loopSound = 1;
	return ( qtrue );
}
...
/* */
qboolean
G_ScriptAction_UnFreezeAnimation ( gentity_t *ent, char *params )
{
	ent->s.loopSound = 0;
	return ( qtrue );
}
...
/* */
qboolean
G_ScriptAction_StartAnimation ( gentity_t *ent, char *params )
{
	char		*pString;
	char		*token;
...
/* */
qboolean
G_ScriptAction_SetSpeed ( gentity_t *ent, char *params )
{
	vec3_t		speed;
	char		*pString;
	int			i;
...
/* */
qboolean
G_ScriptAction_SetRotation ( gentity_t *ent, char *params )
{
	vec3_t	angles;
	char	*pString;
	int		i;
...
/* */
qboolean
G_ScriptAction_StopRotation ( gentity_t *ent, char *params )
{
	BG_EvaluateTrajectory( &ent->s.apos, level.time, ent->r.currentAngles, qtrue, ent->s.effect2Time );
	VectorCopy( ent->r.currentAngles, ent->s.apos.trBase );
	ent->s.apos.trTime = level.time;
...
*/
qboolean
G_ScriptAction_FollowSpline ( gentity_t *ent, char *params )
{
	char		*pString, *token;
	vec3_t		vec;
	float		speed;
...
*/
qboolean
G_ScriptAction_AbortMove ( gentity_t *ent, char *params )
{
	ent->scriptStatus.scriptFlags &= ~SCFL_GOING_TO_MARKER;
...
*/
qboolean
G_ScriptAction_SetChargeTimeFactor ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	float	factor;
	team_t	team;
...
*/
qboolean
G_ScriptAction_SpawnRubble ( gentity_t *ent, char *params )
{
	int i;
...
*/
qboolean
G_ScriptAction_AllowTankExit ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	pString = params;
	token = COM_ParseExt( &pString, qfalse );
...
/* */
qboolean
G_ScriptAction_AllowTankEnter ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	pString = params;
	token = COM_ParseExt( &pString, qfalse );
...
/* */
qboolean
G_ScriptAction_SetTankAmmo ( gentity_t *ent, char *params )
{
	char		*pString, *token;
	gentity_t	*tank;
	pString = params;
...
/* */
qboolean
G_ScriptAction_AddTankAmmo ( gentity_t *ent, char *params )
{
	char		*pString, *token;
	gentity_t	*tank;
	pString = params;
...
/* */
qboolean
G_ScriptAction_DisableMessage ( gentity_t *ent, char *params )
{
	char		*pString, *token;
...
*/
qboolean
G_ScriptAction_Kill ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	pString = params;
	token = COM_ParseExt( &pString, qfalse );
...
*/
qboolean
G_ScriptAction_SetGlobalFog ( gentity_t *ent, char *params )
{
	char		*pString, *token;
	qboolean	restore;
	int			duration;
...
*/
qboolean
G_ScriptAction_GotoMarker ( gentity_t *ent, char *params )
{
	char		*pString, *token;
	gentity_t	*target = NULL;
	vec3_t		vec;
...
*/
qboolean
G_ScriptAction_Wait ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	int		duration;
...
=================
*/
qboolean G_SP_ScriptAction_Trigger2( gentity_t *ent, char *params )
{
	gentity_t *trent;
...
//		AICast_ScriptEvent( AICast_GetCastState( trent->s.number ), "trigger", trigger );
	...
	if (trent) {
		oldId = trent->scriptStatus.scriptId;
		G_SP_script_ScriptEvent( trent, "trigger", trigger );
...
*/
qboolean
G_ScriptAction_Trigger ( gentity_t *ent, char *params )
{
	gentity_t	*trent;
	char		*pString, name[MAX_QPATH], trigger[MAX_QPATH], *token;
	int			oldId, i;
	...
	{
		return G_SP_ScriptAction_Trigger2( ent, params );
	}
	...
	else if ( !Q_stricmp( name, "activator") )
	{
		...
		(
			...
			(ent->activator->r.svFlags & SVF_BOT) &&
			ent->inuse &&
...
*/
qboolean
G_ScriptAction_PlaySound ( gentity_t *ent, char *params )
{
	char		*pString, *token;
...
*/
qboolean
G_ScriptAction_FadeAllSounds ( gentity_t *ent, char *params )
{
	char		*pString, *token;
	qboolean	up = qfalse;
	int			time;
...
*/
qboolean
G_ScriptAction_MusicStart ( gentity_t *ent, char *params )
{
	char	*pString, *token;
...
*/
qboolean
G_ScriptAction_MusicPlay ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	char	cvarName[MAX_QPATH];
	int		fadeupTime = 0;
...
*/
qboolean
G_ScriptAction_MusicStop ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	int		fadeoutTime = 0;
	pString = params;
...
*/
qboolean
G_ScriptAction_MusicQueue ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	char	cvarName[MAX_QPATH];
	pString = params;
...
*/
qboolean
G_ScriptAction_MusicFade ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	int		fadeoutTime = 0;
	float	targetVol = 0.0;
...
*/
qboolean
G_ScriptAction_PlayAnim ( gentity_t *ent, char *params )
{
...
*/
qboolean
G_ScriptAction_AlertEntity ( gentity_t *ent, char *params )
{
...
*/
qboolean
G_ScriptAction_ToggleSpeaker ( gentity_t *ent, char *params )
{
	int				i;
	long			hash;
	gentity_t		*tent;
...
*/
qboolean
G_ScriptAction_DisableSpeaker ( gentity_t *ent, char *params )
{
	int				i;
	long			hash;
	gentity_t		*tent;
...
*/
qboolean
G_ScriptAction_EnableSpeaker ( gentity_t *ent, char *params )
{
	int				i;
	long			hash;
	gentity_t		*tent;
...
/* */
qboolean
G_ScriptAction_Accum ( gentity_t *ent, char *params )
{
...
*/
qboolean
G_ScriptAction_GlobalAccum ( gentity_t *ent, char *params )
{
	char		*pString, *token, lastToken[MAX_QPATH], name[MAX_QPATH];
	int			bufferIndex;
	qboolean	terminate, found;
...
*/
qboolean
G_ScriptAction_Print ( gentity_t *ent, char *params )
{
...
*/
qboolean
G_ScriptAction_FaceAngles ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	int		duration, i;
	vec3_t	diff;
...
*/
qboolean
G_ScriptAction_ResetScript ( gentity_t *ent, char *params )
{
...
*/
qboolean
G_ScriptAction_TagConnect ( gentity_t *ent, char *params )
{
	char		*pString, *token;
	gentity_t	*parent;
	pString = params;
...
*/
qboolean
G_ScriptAction_Halt ( gentity_t *ent, char *params )
{
	if ( level.time == ent->scriptStatus.scriptStackChangeTime )
	{
		ent->scriptStatus.scriptFlags &= ~SCFL_GOING_TO_MARKER;
...
*/
qboolean
G_ScriptAction_StopSound ( gentity_t *ent, char *params )
{
	ent->s.loopSound = 0;
	return ( qtrue );
}
...
*/
qboolean
G_ScriptAction_EntityScriptName ( gentity_t *ent, char *params )
{
...
*/
qboolean
G_ScriptAction_AIScriptName ( gentity_t *ent, char *params )
{
	return ( qtrue );
}
...
*/
qboolean
G_ScriptAction_AxisRespawntime ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	pString = params;
	token = COM_Parse( &pString );
...
G_ScriptAction_Camo
  ...
  syntax: wm_camo <string>
===================
*/
qboolean
G_ScriptAction_Camo ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	pString = params;
	token = COM_Parse( &pString );
	if ( !token[0] )
	{
		G_Error( "G_ScriptAction_Camo: camo name parameter required\n" );
	}

	trap_Cvar_Set( "g_camo_axis", va( "%s", token) );
	trap_Cvar_Set( "g_camo_allies", va( "%s", token) );
	return ( qtrue );
}
...
/*
===================
G_ScriptAction_Camo_Allies

  syntax: wm_camo_allies <string> 
===================
*/
qboolean
G_ScriptAction_Camo_Allies ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	pString = params;
	token = COM_Parse( &pString );
	if ( !token[0] )
	{
		G_Error( "G_ScriptAction_Camo_Allies: camo name parameter required\n" );
	}
...
/*
===================
G_ScriptAction_Camo_Axis

  syntax: wm_camo_axis <string> 
===================
*/
qboolean
G_ScriptAction_Camo_Axis ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	pString = params;
	token = COM_Parse( &pString );
	if ( !token[0] )
	{
		G_Error( "G_ScriptAction_Camo_Axis: camo name parameter required\n" );
	}
...
*/
qboolean
G_ScriptAction_AlliedRespawntime ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	pString = params;
	token = COM_Parse( &pString );
...
*/
qboolean
G_ScriptAction_NumberofObjectives ( gentity_t *ent, char *params )
{
	char	*pString, *token;
...
*/
qboolean
G_ScriptAction_SetMainObjective ( gentity_t *ent, char *params )
{
...
*/
qboolean
G_ScriptAction_ObjectiveStatus ( gentity_t *ent, char *params )
{
	...
	{
		TriggerInfo ti;
		ti.m_Action = "objective_status";
		ti.m_Activator = NULL;
		ti.m_TagName = token;
		ti.m_Entity = ent;
		ti.m_UserData.m_DataType = dt3_Strings;
		ti.m_UserData.udata.m_CharPtrs[0] = pConfigStr;
		switch ( atoi( token) )
		{
			case 0:
				ti.m_UserData.udata.m_CharPtrs[1] = "default";
				break;
			case 1:
				ti.m_UserData.udata.m_CharPtrs[1] = "complete";
				break;
			case 2:
				ti.m_UserData.udata.m_CharPtrs[1] = "failed";
				break;
		}

		ti.m_UserData.udata.m_CharPtrs[2] = 0;
...
/* */
qboolean
G_ScriptAction_SetDebugLevel ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	int		debugLevel = 0;
	if ( !params || !params[0] )
...
/* */
qboolean
G_ScriptAction_VoiceAnnounce ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	int		num, sysmsg;
...
*/
qboolean
G_ScriptAction_SetWinner ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	char	cs[MAX_STRING_CHARS];
	int		num;
	...
	if ( g_gametype.integer == GT_WOLF_TDM || g_gametype.integer == GT_WOLF_DM || g_gametype.integer == GT_WOLF_CTF )
	{
		num = -1;
	}
...
*/
qboolean
G_ScriptAction_SetDefendingTeam ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	char	cs[MAX_STRING_CHARS];
	int		num;
...
*/
qboolean
G_ScriptAction_AddTeamVoiceAnnounce ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	int		team, i, index;
...
/* */
qboolean
G_ScriptAction_RemoveTeamVoiceAnnounce ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	int		team;
	int		index, i;
...
*/
qboolean
G_ScriptAction_TeamVoiceAnnounce ( gentity_t *ent, char *params )
{
	char		*pString, *token;
	team_t		team;
	gentity_t	*tent;
...
*/
qboolean
G_ScriptAction_Announce_Icon ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	int		iconnumber;
	if ( g_gamestate.integer == GS_INTERMISSION )
...
*/
qboolean
G_ScriptAction_Announce ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	if ( g_gamestate.integer == GS_INTERMISSION )
	{
...
/* */
qboolean
G_ScriptAction_EndRound ( gentity_t *ent, char *params )
{
	if ( g_gamestate.integer == GS_INTERMISSION )
	{
		return ( qtrue );
...
*/
qboolean
G_ScriptAction_SetRoundTimelimit ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	float	nextTimeLimit;
	pString = params;
...
*/
qboolean
G_ScriptAction_RemoveEntity ( gentity_t *ent, char *params )
{
...
*/
qboolean
G_ScriptAction_SetDamagable ( gentity_t *ent, char *params )
{
	gentity_t	*target;
...
*/
qboolean
G_ScriptAction_SetState ( gentity_t *ent, char *params )
{
	gentity_t	*target;
	char		*pString, name[MAX_QPATH], state[MAX_QPATH], *token;
...
*/
qboolean
G_ScriptAction_StartCam ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	char	camfile[256];
	if ( !ent->client )
...
*/
qboolean
G_ScriptAction_SetInitialCamera ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	char	camfile[256];
	if ( !ent->client )
...
#ifdef _DEBUG
	G_Printf("G_ScriptAction_SetInitialCamera\n");
#endif
...
*/
qboolean
G_ScriptAction_StopCam ( gentity_t *ent, char *params )
{
	if ( !ent->client )
	{
		return ( qfalse );
...
*/
qboolean
G_ScriptAction_RepairMG42 ( gentity_t *ent, char *params )
{
	gentity_t	*target;
...
*/
qboolean
G_ScriptAction_SetHQStatus ( gentity_t *ent, char *params )
{
	char		*pString, *token;
	team_t		team;
...
*/
qboolean
G_ScriptAction_PrintAccum ( gentity_t *ent, char *params )
{
	char	*token, *pString;
	int		bufferIndex;
	if ( !params || !params[0] )
...
*/
qboolean
G_ScriptAction_PrintGlobalAccum ( gentity_t *ent, char *params )
{
	char	*token, *pString;
	int		bufferIndex;
	if ( !params || !params[0] )
...
*/
qboolean
G_ScriptAction_RemoveBot ( gentity_t *ent, char *params )
{
	char	*token, *pString;
	if ( !params || !params[0] )
	{
...
*/
qboolean
G_ScriptAction_BotDebugging ( gentity_t *ent, char *params )
{
#ifndef NO_BOT_SUPPORT
	char	*token, *pString;
	if ( !params || !params[0] )
...
/* */
qboolean
G_IsValidBotStateGoal ( gentity_t *ent )
{
	switch ( ent->s.eType )
	{
		case ET_MOVER:
...
*/
qboolean
G_ScriptAction_SetBotGoalState ( gentity_t *ent, char *params )
{
	gentity_t	*target;
	char		*pString, name[MAX_QPATH], *token;
...
*/
qboolean
G_ScriptAction_SetAASState ( gentity_t *ent, char *params )
{
	gentity_t	*target = NULL;
...
*/
qboolean
G_ScriptAction_SetBotGoalPriority ( gentity_t *ent, char *params )
{
	gentity_t	*target;
	char		*pString, name[MAX_QPATH], *token;
	qboolean	teamFlags[2] = { qtrue, qtrue };	// default to both
...
/* */
qboolean
G_ScriptAction_Construct ( gentity_t *ent, char *params )
{
	char		*pString, *token;
...
*/
qboolean
G_ScriptAction_ConstructibleClass ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	int		value;
	pString = params;
...
*/
qboolean
G_ScriptAction_ConstructibleChargeBarReq ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	float	value;
	pString = params;
...
*/
qboolean
G_ScriptAction_ConstructibleConstructXPBonus ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	int		value;
	pString = params;
...
*/
qboolean
G_ScriptAction_ConstructibleDestructXPBonus ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	int		value;
	pString = params;
...
*/
qboolean
G_ScriptAction_ConstructibleHealth ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	int		value;
	pString = params;
...
*/
qboolean
G_ScriptAction_ConstructibleWeaponclass ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	int		value;
	pString = params;
...
*/
qboolean
G_ScriptAction_ConstructibleDuration ( gentity_t *ent, char *params )
{
	char	*pString, *token;
	int		value;
	pString = params;
...
*/
qboolean
G_ScriptAction_SpawnBot ( gentity_t *ent, char *params )
{
...
*/
qboolean
G_ScriptAction_Cvar ( gentity_t *ent, char *params )
{
...
*/
qboolean
G_ScriptAction_AbortIfWarmup ( gentity_t *ent, char *params )
{
	if ( level.warmupTime )
	{
...
*/
qboolean
G_ScriptAction_AbortIfNotSinglePlayer ( gentity_t *ent, char *params )
{
...
*/
qboolean
etpro_ScriptAction_SetValues ( gentity_t *ent, char *params )
{
	char	*token;
	char	*p;
	...
	while ( 1 )
	{
		...
		{
			G_Printf( "%d : (%s) %s: set [%s] [%s] [%s]\n", level.time, ent->scriptName, GAMEVERSION, ent->scriptName,
					  key, value );
		}
...
qboolean
G_ScriptAction_Create ( gentity_t *ent, char *params )
{
	gentity_t	*create;
	char		*token;
	char		*p;
...
// UQ1: Now the Single Player RTCW ones...
