...
*/
qboolean
COM_BitCheck ( const int array[], int bitNum )
{
	int i;
	i = 0;
	while ( bitNum > 31 )
...
*/
void
COM_BitSet ( int array[], int bitNum )
{
	int i;
	i = 0;
	while ( bitNum > 31 )
...
*/
void
COM_BitClear ( int array[], int bitNum )
{
	int i;
	i = 0;
	while ( bitNum > 31 )
...
/* */
void
COM_BackupParseSession ( char **data_p )
{
...
/* */
void
COM_RestoreParseSession ( char **data_p )
{
...
/* */
void
COM_SetCurrentParseLine ( int line )
{
	com_lines = line;
}
...
*/
void
SkipBracedSection_Depth ( char **program, int depth )
{
	char	*token;
	do
	{
...
*/
int
Com_ParseInfos ( char *buf, int max, char infos[][MAX_INFO_STRING] )
{
	const char	*token;
	int			count;
...
*/
int
GetIDForString ( stringID_table_t *table, const char *string )
{
	int index = 0;
...
*/
const char *
GetStringForID ( stringID_table_t *table, int id )
{
	int index = 0;
	while ( (table[index].name != NULL) && (table[index].name[0] != 0) )
	{
