...
#ifdef __BOT__
extern void			SOD_SPAWN_SaveBots ( void );
#endif //__BOT__
#define T_FFA	0x01
#define T_1V1	0x02
#define T_SP	0x04
...
{
	{ 0x1ff, "comp", G_Comp_v, "Load Competition Settings",
	...
	{ 0x1ff, "shuffleteamsxp", G_ShuffleTeams_v, "Shuffle Teams by XP",
			" ^7\n  Randomly place players on each team, based on XP" },
	{ 0x1ff, "startmatch", G_StartMatch_v, "Start Match",
...
int
G_voteCmdCheck ( gentity_t *ent, char *arg, char *arg2, qboolean fRefereeCmd )
{
...
// Voting help summary.
void
G_voteHelp ( gentity_t *ent, qboolean fShowVote )
{
	...
	for ( i = 0; i < rows; i++ )
	{
		...
		{
			G_refPrintf( ent, "^5%-17s%-17s%-17s%-17s", aVoteInfo[vi[i]].pszVoteName, aVoteInfo[vi[i + rows]].pszVoteName,
						 aVoteInfo[vi[i + rows * 2]].pszVoteName, aVoteInfo[vi[i + rows * 3]].pszVoteName );
		}
		else if ( i + rows * 2 + 1 <= num_cmds )
		{
			G_refPrintf( ent, "^5%-17s%-17s%-17s", aVoteInfo[vi[i]].pszVoteName, aVoteInfo[vi[i + rows]].pszVoteName,
...
qboolean
G_voteDescription ( gentity_t *ent, qboolean fRefereeCmd, int cmd )
{
...
void
G_voteDisableMessage ( gentity_t *ent, const char *cmd )
{
...
void
G_playersMessage ( gentity_t *ent )
{
...
void
G_voteCurrentSetting ( gentity_t *ent, const char *cmd, const char *setting )
{
...
//
void
G_voteSetOnOff ( const char *desc, const char *cvar )
{
...
/* */
void
G_voteSetValue ( const char *desc, const char *cvar )
{
...
/* */
void
G_voteSetVoteString ( const char *desc )
{
...
int
G_Comp_v ( gentity_t *ent, unsigned int dwVoteIndex, char *arg, char *arg2, qboolean fRefereeCmd )
{
...
G_GametypeList ( gentity_t *ent )
{
	...
	{
#ifdef __SUPREMACY__
		if ( i != GT_WOLF_CAMPAIGN && i != GT_SUPREMACY_CAMPAIGN )
#else //__SUPREMACY__
...
// *** GameType ***
int
G_Gametype_v ( gentity_t *ent, unsigned int dwVoteIndex, char *arg, char *arg2, qboolean fRefereeCmd )
{
...
#ifdef __SUPREMACY__
		if ( i < GT_WOLF || i >= GT_MAX_GAME_TYPE || i == GT_WOLF_CAMPAIGN || i == GT_SUPREMACY_CAMPAIGN )
#else //__SUPREMACY__
...
// *** Player Kick ***
int
G_Kick_v ( gentity_t *ent, unsigned int dwVoteIndex, char *arg, char *arg2, qboolean fRefereeCmd )
{
...
// *** Player Mute ***
int
G_Mute_v ( gentity_t *ent, unsigned int dwVoteIndex, char *arg, char *arg2, qboolean fRefereeCmd )
{
	if ( fRefereeCmd )
	{	// handled elsewhere
		return ( G_NOTFOUND );
...
// *** Player Un-Mute ***
int
G_UnMute_v ( gentity_t *ent, unsigned int dwVoteIndex, char *arg, char *arg2, qboolean fRefereeCmd )
{
	if ( fRefereeCmd )
	{	// handled elsewhere
		return ( G_NOTFOUND );
...
int
G_Map_v ( gentity_t *ent, unsigned int dwVoteIndex, char *arg, char *arg2, qboolean fRefereeCmd )
{
...
int
G_Campaign_v ( gentity_t *ent, unsigned int dwVoteIndex, char *arg, char *arg2, qboolean fRefereeCmd )
{
...
// *** Map Restart ***
int
G_MapRestart_v ( gentity_t *ent, unsigned int dwVoteIndex, char *arg, char *arg2, qboolean fRefereeCmd )
{
...
// *** Match Restart ***
int
G_MatchReset_v ( gentity_t *ent, unsigned int dwVoteIndex, char *arg, char *arg2, qboolean fRefereeCmd )
{
...
// *** Mute Spectators ***
int
G_Mutespecs_v ( gentity_t *ent, unsigned int dwVoteIndex, char *arg, char *arg2, qboolean fRefereeCmd )
{
	...
	if ( arg )
	{
		return
			(
				G_voteProcessOnOff( ent, arg, arg2, fRefereeCmd, !!(match_mutespecs.integer),
									vote_allow_mutespecs.integer, dwVoteIndex)
			);
...
// *** Nextmap ***
int
G_Nextmap_v ( gentity_t *ent, unsigned int dwVoteIndex, char *arg, char *arg2, qboolean fRefereeCmd )
{
...
int
G_Pub_v ( gentity_t *ent, unsigned int dwVoteIndex, char *arg, char *arg2, qboolean fRefereeCmd )
{
...
// *** Referee voting ***
int
G_Referee_v ( gentity_t *ent, unsigned int dwVoteIndex, char *arg, char *arg2, qboolean fRefereeCmd )
{
...
// *** Shuffle teams
int
G_ShuffleTeams_v ( gentity_t *ent, unsigned int dwVoteIndex, char *arg, char *arg2, qboolean fRefereeCmd )
{
...
// *** Start Match ***
int
G_StartMatch_v ( gentity_t *ent, unsigned int dwVoteIndex, char *arg, char *arg2, qboolean fRefereeCmd )
{
...
// *** Swap teams
int
G_SwapTeams_v ( gentity_t *ent, unsigned int dwVoteIndex, char *arg, char *arg2, qboolean fRefereeCmd )
{
...
// *** Team Damage ***
int
G_FriendlyFire_v ( gentity_t *ent, unsigned int dwVoteIndex, char *arg, char *arg2, qboolean fRefereeCmd )
{
	...
	if ( arg )
	{
		return
			(
				G_voteProcessOnOff( ent, arg, arg2, fRefereeCmd, !!(g_friendlyFire.integer),
									vote_allow_friendlyfire.integer, dwVoteIndex)
			);
...
// Anti-Lag
int
G_AntiLag_v ( gentity_t *ent, unsigned int dwVoteIndex, char *arg, char *arg2, qboolean fRefereeCmd )
{
	...
	if ( arg )
	{
		return
			(
				G_voteProcessOnOff( ent, arg, arg2, fRefereeCmd, !!(g_antilag.integer), vote_allow_antilag.integer,
									dwVoteIndex)
			);
...
// Balanced Teams
int
G_BalancedTeams_v ( gentity_t *ent, unsigned int dwVoteIndex, char *arg, char *arg2, qboolean fRefereeCmd )
{
	...
	if ( arg )
	{
		return
			(
				G_voteProcessOnOff( ent, arg, arg2, fRefereeCmd, !!(g_balancedteams.integer),
									vote_allow_balancedteams.integer, dwVoteIndex)
			);
...
// *** Timelimit ***
int
G_Timelimit_v ( gentity_t *ent, unsigned int dwVoteIndex, char *arg, char *arg2, qboolean fRefereeCmd )
{
...
/* */
void
G_WarmupDamageTypeList ( gentity_t *ent )
{
	int i;
...
// *** Warmup Weapon Fire ***
int
G_Warmupfire_v ( gentity_t *ent, unsigned int dwVoteIndex, char *arg, char *arg2, qboolean fRefereeCmd )
{
...
// *** Un-Referee voting ***
int
G_Unreferee_v ( gentity_t *ent, unsigned int dwVoteIndex, char *arg, char *arg2, qboolean fRefereeCmd )
{
