...
{
	syscall( UI_R_ADDLIGHTTOSCENE, org, PASSFLOAT( radius), PASSFLOAT( intensity), PASSFLOAT( r), PASSFLOAT( g),
...
{
	syscall( UI_R_DRAWROTATEDPIC, PASSFLOAT( x), PASSFLOAT( y), PASSFLOAT( w), PASSFLOAT( h), PASSFLOAT( s1),
...
/* */
int
trap_CM_LerpTag ( orientation_t *tag, const refEntity_t *refent, const char *tagName, int startIndex )
{
...
/* */
void
trap_S_FadeAllSound ( float targetvol, int time, qboolean stopsound )
{
...
/* */
int
trap_LAN_GetLocalServerCount ( void )
{
...
/* */
void
trap_LAN_GetLocalServerAddressString ( int n, char *buf, int buflen )
{
...
/* */
int
trap_LAN_GetGlobalServerCount ( void )
{
...
/* */
void
trap_LAN_GetGlobalServerAddressString ( int n, char *buf, int buflen )
{
...
/* */
qboolean
trap_LAN_ServerIsInFavoriteList ( int source, int n )
{
...
/* */
int
trap_PC_RemoveAllGlobalDefines ( void )
{
...
// NERVE - SMF
qboolean
trap_GetLimboString ( int index, char *buf )
{
...
/* */
char *
trap_TranslateString ( const char *string )
{
