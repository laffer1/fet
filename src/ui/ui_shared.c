...
/* */
void
Tooltip_Initialize ( itemDef_t *item )
{
	item->text = NULL;
...
/* */
void
Tooltip_ComputePosition ( itemDef_t *item )
{
...
*/
qboolean
PC_Char_Parse ( int handle, char *out )
{
	pc_token_t	token;
...
Menu_ItemsMatchingGroup ( menuDef_t *menu, const char *name )
{
	...
	for ( i = 0; i < menu->itemCount; i++ )
	{
		if ( wildcard != -1 )
		{
			if
			(
				Q_strncmp( menu->items[i]->window.name, name, wildcard) == 0 ||
		...
		else
		{
			if
			(
				Q_stricmp( menu->items[i]->window.name, name) == 0 ||
...
/* */
void
Script_SetColor ( itemDef_t *item, qboolean *bAbort, char **args )
{
...
/* */
void
Script_SetAsset ( itemDef_t *item, qboolean *bAbort, char **args )
{
	const char	*name;
...
/* */
void
Script_SetBackground ( itemDef_t *item, qboolean *bAbort, char **args )
{
	const char	*name = NULL;
...
/* */
void
Script_SetTeamColor ( itemDef_t *item, qboolean *bAbort, char **args )
{
	if ( DC->getTeamColor )
	{
		int		i;
...
/* */
void
Script_SetItemColor ( itemDef_t *item, qboolean *bAbort, char **args )
{
...
/* */
void
Script_SetMenuItemColor ( itemDef_t *item, qboolean *bAbort, char **args )
{
...
/* */
void
Script_Show ( itemDef_t *item, qboolean *bAbort, char **args )
{
	const char	*name = NULL;
	if ( String_Parse( args, &name) )
	{
...
/* */
void
Script_Hide ( itemDef_t *item, qboolean *bAbort, char **args )
{
	const char	*name = NULL;
	if ( String_Parse( args, &name) )
	{
...
/* */
void
Script_FadeIn ( itemDef_t *item, qboolean *bAbort, char **args )
{
	const char	*name = NULL;
	if ( String_Parse( args, &name) )
	{
...
/* */
void
Script_FadeOut ( itemDef_t *item, qboolean *bAbort, char **args )
{
	const char	*name = NULL;
	if ( String_Parse( args, &name) )
	{
...
/* */
void
Script_Open ( itemDef_t *item, qboolean *bAbort, char **args )
{
	const char	*name = NULL;
	if ( String_Parse( args, &name) )
	{
...
/* */
void
Menu_FadeMenuByName ( const char *p, qboolean *bAbort, qboolean fadeOut )
{
	itemDef_t	*item;
	int			i;
	menuDef_t	*menu = Menus_FindByName( p );
...
/* */
void
Script_FadeInMenu ( itemDef_t *item, qboolean *bAbort, char **args )
{
	const char	*name = NULL;
	if ( String_Parse( args, &name) )
	{
...
/* */
void
Script_FadeOutMenu ( itemDef_t *item, qboolean *bAbort, char **args )
{
	const char	*name = NULL;
	if ( String_Parse( args, &name) )
	{
...
// DHM - Nerve
void
Script_ConditionalOpen ( itemDef_t *item, qboolean *bAbort, char **args )
{
	...
	if
	(
		String_Parse( args, &cvar) &&
		Int_Parse( args, &testtype) &&
		String_Parse( args, &name1) &&
...
/* */
void
Script_ConditionalScript ( itemDef_t *item, qboolean *bAbort, char **args )
{
	const char	*cvar;
	const char	*script1;
	const char	*script2;
...
// DHM - Nerve
void
Script_Close ( itemDef_t *item, qboolean *bAbort, char **args )
{
	const char	*name = NULL;
	if ( String_Parse( args, &name) )
	{
...
/* */
void
Script_CloseAll ( itemDef_t *item, qboolean *bAbort, char **args )
{
	Menus_CloseAll();
}
...
/* */
void
Script_CloseAllOtherMenus ( itemDef_t *item, qboolean *bAbort, char **args )
{
	int i;
	for ( i = 0; i < menuCount; i++ )
	{
...
*/
void
Script_Clipboard ( itemDef_t *item, qboolean *bAbort, char **args )
{
...
*/
void
Script_NotebookShowpage ( itemDef_t *item, qboolean *bAbort, char **args )
{
...
/* */
void
Script_Transition ( itemDef_t *item, qboolean *bAbort, char **args )
{
	const char	*name = NULL;
...
/* */
void
Script_Orbit ( itemDef_t *item, qboolean *bAbort, char **args )
{
	const char	*name = NULL;
...
/* */
void
Script_SetFocus ( itemDef_t *item, qboolean *bAbort, char **args )
{
	const char	*name = NULL;
	itemDef_t	*focusItem;
	if ( String_Parse( args, &name) )
...
/* */
void
Script_ClearFocus ( itemDef_t *item, qboolean *bAbort, char **args )
{
	Menu_ClearFocus( item->parent );
}
...
/* */
void
Script_SetPlayerModel ( itemDef_t *item, qboolean *bAbort, char **args )
{
	const char	*name = NULL;
	if ( String_Parse( args, &name) )
	{
...
/* */
void
Script_SetPlayerHead ( itemDef_t *item, qboolean *bAbort, char **args )
{
	const char	*name = NULL;
	if ( String_Parse( args, &name) )
	{
...
void
Script_ClearCvar ( itemDef_t *item, qboolean *bAbort, char **args )
{
	const char	*cvar;
...
/* */
void
Script_SetCvar ( itemDef_t *item, qboolean *bAbort, char **args )
{
...
/* */
void
Script_CopyCvar ( itemDef_t *item, qboolean *bAbort, char **args )
{
...
/* */
void
Script_Exec ( itemDef_t *item, qboolean *bAbort, char **args )
{
	const char	*val = NULL;
...
/* */
void
Script_ExecNOW ( itemDef_t *item, qboolean *bAbort, char **args )
{
	const char	*val = NULL;
	if ( String_Parse( args, &val) )
	{
...
/* */
void
Script_Play ( itemDef_t *item, qboolean *bAbort, char **args )
{
	const char	*val = NULL;
	if ( String_Parse( args, &val) )
	{
...
/* */
void
Script_playLooped ( itemDef_t *item, qboolean *bAbort, char **args )
{
	const char	*val = NULL;
	if ( String_Parse( args, &val) )
	{
...
// NERVE - SMF
void
Script_AddListItem ( itemDef_t *item, qboolean *bAbort, char **args )
{
...
// DHM - Nerve
void
Script_CheckAutoUpdate ( itemDef_t *item, qboolean *bAbort, char **args )
{
	DC->checkAutoUpdate();
}
...
/* */
void
Script_GetAutoUpdate ( itemDef_t *item, qboolean *bAbort, char **args )
{
	DC->getAutoUpdate();
}
...
// DHM - Nerve
void
Script_SetMenuFocus ( itemDef_t *item, qboolean *bAbort, char **args )
{
	const char	*name;
	if ( String_Parse( args, &name) )
	{
...
/* */
qboolean
Script_CheckProfile ( char *profile_path )
{
	fileHandle_t	f;
	char			f_data[32];
	int				f_pid;
...
/* */
qboolean
Script_WriteProfile ( char *profile_path )
{
	fileHandle_t	f;
	char			com_pid[256];
...
/* */
void
Script_ExecWolfConfig ( itemDef_t *item, qboolean *bAbort, char **args )
{
	char			cl_profileStr[256];
	int				useprofile = 1;
	int				len = 0, i = 0;
	...
	if ( Int_Parse( args, &useprofile) )
	{
		...
		{
			Com_sprintf( cfgPath, sizeof(cfgPath), "profiles/%s/%s", cl_profileStr, CONFIG_NAME );
			Com_sprintf( bakPath, sizeof(bakPath), "profiles/%s/%s.etpub", cl_profileStr, CONFIG_NAME );
...
/* */
void
Script_SetEditFocus ( itemDef_t *item, qboolean *bAbort, char **args )
{
	const char	*name = NULL;
	itemDef_t	*editItem;
	if ( String_Parse( args, &name) )
...
/* */
void
Script_Abort ( itemDef_t *item, qboolean *bAbort, char **args )
{
	*bAbort = qtrue;
}
...
commandDef_t	commandList[] =
{
	...
	// menu
	{ "fadeinmenu", &Script_FadeInMenu },

	// menu
	{ "fadeoutmenu", &Script_FadeOutMenu },

	// menu
	{ "conditionalopen", &Script_ConditionalOpen },

	// DHM - Nerve:: cvar menu menu
	// opens first menu if cvar is true[non-zero], second if false
	{ "conditionalscript", &Script_ConditionalScript },

	// as conditonalopen, but then executes scripts
	{ "close", &Script_Close },

	// menu
	{ "closeall", &Script_CloseAll },
	{ "closeallothermenus", &Script_CloseAllOtherMenus },
	{ "clipboard", &Script_Clipboard },

	// show the current clipboard group by name
	...
	// group/name
	{ "setmenuitemcolor", &Script_SetMenuItemColor },
	...
	// NERVE - SMF - special command to add text items to list box
	...
	// DHM - Nerve
	{ "setmenufocus", &Script_SetMenuFocus },

	// focus menu
	{ "execwolfconfig", &Script_ExecWolfConfig },

	// executes etconfig.cfg
...
/* */
void
Item_RunScript ( itemDef_t *item, qboolean *bAbort, const char *s )
{
	char		script[4096], *p;
	int			i;
	qboolean	bRan;
...
qboolean
Item_SettingShow ( itemDef_t *item, qboolean fVoteTest )
{
	char	info[MAX_INFO_STRING];
	if ( fVoteTest )
	{
...
/* */
void
Item_ListBox_MouseEnter ( itemDef_t *item, float x, float y, qboolean click )
{
	rectDef_t		r;
	listBoxDef_t	*listPtr = (listBoxDef_t *) item->typeData;
	item->window.flags &= ~
	...
	)
	{
		...
		if ( key == K_MOUSE1 || key == K_MOUSE2 )
		{
			...
			else
			{
				...
				(
					item->cursorPos == listPtr->cursorPos &&
					DC->realTime < lastListBoxClickTime &&
					listPtr->doubleClick
				)
				{
...
/* */
qboolean
Item_CheckBox_HandleKey ( itemDef_t *item, int key )
{
	if
	(
...
Menu_HandleKey ( menuDef_t *menu, int key, qboolean down )
{
	...
	else if ( key > 0 && key <= 255 )
	{
		...
		for ( i = 0; i < menu->itemCount; i++ )
		{
			...
			if ( it->hotkey == key // and is this item visible?
...
Item_TextField_Paint ( itemDef_t *item )
{
	...
	if ( item->window.flags & WINDOW_HASFOCUS && g_editingField )
	{
		...
		DC->drawTextWithCursor( item->textRect.x + item->textRect.w + offset + screen_offset, item->textRect.y,
								item->textscale, newColor, buff + editPtr->paintOffset + field_offset,
								item->cursorPos - editPtr->paintOffset - field_offset, cursor, editPtr->maxPaintChars,
								item->textStyle );
	}
	else
	{
		DC->drawText( item->textRect.x + item->textRect.w + offset + screen_offset, item->textRect.y, item->textscale,
					  newColor, buff + editPtr->paintOffset + field_offset, 0, editPtr->maxPaintChars, item->textStyle );
	}
}
...
/* */
void
Item_CheckBox_Paint ( itemDef_t *item )
{
	vec4_t		newColor, lowLight;
	float		value;
	menuDef_t	*parent = (menuDef_t *) item->parent;
	...
	if ( item->text )
	{
		...
		if ( hasMultiText )
		{
			...
			DC->drawText( item->textRect.x + item->textRect.w + 8 + item->window.rect.h + 4, item->textRect.y,
						  item->textscale, colour, Item_Multi_Setting( item), 0, 0, item->textStyle );
		}
	}
	else
	{
		...
		if ( hasMultiText )
		{
			vec4_t	colour;
			Item_TextColor( item, &colour );
			DC->drawText( item->window.rect.x + item->window.rect.h + 4, item->window.rect.y + item->textaligny,
						  item->textscale, colour, Item_Multi_Setting( item), 0, 0, item->textStyle );
		}
	}
}
...
#ifdef __BOT__
	{ "addnode", 'g', -1, 'g', -1, -1, -1 },
	{ "addnode axis", 'h', -1, 'h', -1, -1, -1 },
	{ "addnode allied", 'j', -1, 'j', -1, -1, -1 },
	{ "addnode vehicle", 'k', -1, 'k', -1, -1, -1 },
	{ "deletenode", 'i', -1, 'i', -1, -1, -1 },
	{ "savenodes", 'n', -1, 'n', -1, -1, -1 },
#endif //__BOT__
	{ "thirdperson", 'i', -1, 'i', -1, -1, -1 },
	{ "+salute", 'k', -1, 'k', -1, -1, -1 },
	{ "holster", 'h', -1, 'h', -1, -1, -1 },
...
*/
void
Controls_SetDefaults ( qboolean lefthanded )
{
	int i;
...
Item_Bind_Paint ( itemDef_t *item )
{
	...
	if ( item->text )
	{
		...
		DC->drawText( item->textRect.x + item->textRect.w + 8, item->textRect.y, item->textscale, newColor, g_nameBind1,
					  0, maxChars, item->textStyle );
	}
	else
	{
		DC->drawText( item->textRect.x, item->textRect.y, item->textscale, newColor, (value != 0) ? "FIXME" : "FIXME",
					  0, maxChars, item->textStyle );
	}
}
...
Item_Model_Paint ( itemDef_t *item )
{
	...
	if ( modelPtr->screenscalex )
	{
		if ( modelPtr->screenscalex != DC->xscale )
		{
			return;
		}
	}
		...
		else
		{
			...
			for ( i = listPtr->startPos; i < count; i++ )
			{
					...
					for ( j = 0; j < listPtr->numColumns; j++ )
					{
						...
						else if ( text )
						{
							DC->drawText( x + 4 + listPtr->columnInfo[j].pos + item->textalignx,
										  y + listPtr->elementHeight + item->textaligny, item->textscale,
				...
				else
				{
					...
					{
						DC->drawText( x + 4 + item->textalignx, y + listPtr->elementHeight + item->textaligny,
...
Menu_HandleMouseMove ( menuDef_t *menu, float x, float y )
{
	...
	for ( pass = 0; pass < 2; pass++ )
	{
		for ( i = 0; i < menu->itemCount; i++ )
		{
			...
			if
			(
				menu->items[i]->cvarFlags & (CVAR_ENABLE | CVAR_DISABLE) &&
			...
			if
			(
				menu->items[i]->cvarFlags & (CVAR_SHOW | CVAR_HIDE) &&
			...
			if
			(
				(menu->items[i]->settingFlags & (SVS_ENABLED_SHOW | SVS_DISABLED_SHOW)) &&
...
Menu_Paint ( menuDef_t *menu, qboolean forcePaint )
{
	...
	if
	(
		DC->getCVarValue( "ui_showtooltips") &&
		item != NULL &&
...
*/
qboolean
Item_ValidateTooltipData ( itemDef_t *item )
{
...
qboolean
ItemParse_textfile ( itemDef_t *item, int handle )
{
	const char	*newtext;
	pc_token_t	token;
	if ( !trap_PC_ReadToken( handle, &token) )
...
// screenscalex <float>
qboolean
ItemParse_screenscalex ( itemDef_t *item, int handle )
{
	modelDef_t	*modelPtr;
	Item_ValidateTypeData( item );
	modelPtr = (modelDef_t *) item->typeData;
	if ( !PC_Float_Parse( handle, &modelPtr->screenscalex) )
	{
		return ( qfalse );
	}
...
qboolean
ItemParse_model_animplay ( itemDef_t *item, int handle )
{
	modelDef_t	*modelPtr;
	Item_ValidateTypeData( item );
	modelPtr = (modelDef_t *) item->typeData;
...
qboolean
ItemParse_origin ( itemDef_t *item, int handle )
{
	int x = 0, y = 0;
...
// textasint
qboolean
ItemParse_textasint ( itemDef_t *item, int handle )
{
...
// textasfloat
qboolean
ItemParse_textasfloat ( itemDef_t *item, int handle )
{
...
qboolean
ItemParse_textfont ( itemDef_t *item, int handle )
{
...
/* */
qboolean
ItemParse_onEsc ( itemDef_t *item, int handle )
{
...
/* */
qboolean
ItemParse_onEnter ( itemDef_t *item, int handle )
{
...
/* */
qboolean
ItemParse_contextMenu ( itemDef_t *item, int handle )
{
	listBoxDef_t	*listPtr;
	Item_ValidateTypeData( item );
	if ( !item->typeData )
...
// NERVE - SMF
qboolean
ItemParse_accept ( itemDef_t *item, int handle )
{
...
/* */
qboolean
ItemParse_cvarListUndefined ( itemDef_t *item, int handle )
{
	pc_token_t	token;
	multiDef_t	*multiPtr;
	Item_ValidateTypeData( item );
...
/* */
qboolean
ParseColorRange ( itemDef_t *item, int handle, int type )
{
	...
	if
	(
		PC_Float_Parse( handle, &color.low) &&
...
/* */
qboolean
ItemParse_addColorRangeRel ( itemDef_t *item, int handle )
{
...
/* */
qboolean
ItemParse_noToggle ( itemDef_t *item, int handle )
{
...
// START - TAT 9/16/2002
qboolean
ItemParse_execKey ( itemDef_t *item, int handle )
{
	char	keyname;
...
qboolean
ItemParse_settingDisabled ( itemDef_t *item, int handle )
{
...
/* */
qboolean
ItemParse_settingEnabled ( itemDef_t *item, int handle )
{
	qboolean	fResult = PC_Int_Parse( handle, &item->settingTest );
	if ( fResult )
	{
...
/* */
qboolean
ItemParse_tooltip ( itemDef_t *item, int handle )
{
...
/* */
qboolean
ItemParse_tooltipalignx ( itemDef_t *item, int handle )
{
...
/* */
qboolean
ItemParse_tooltipaligny ( itemDef_t *item, int handle )
{
...
/* */
qboolean
ItemParse_voteFlag ( itemDef_t *item, int handle )
{
...
keywordHash_t	itemParseKeywords[] =
{
	...
	{ "screenscalex", ItemParse_screenscalex, NULL },
	{ NULL, NULL, NULL }
};
...
/* */
qboolean
MenuParse_onEnter ( itemDef_t *item, int handle )
{
	menuDef_t	*menu = (menuDef_t *) item;
...
qboolean
MenuParse_onTimeout ( itemDef_t *item, int handle )
{
	menuDef_t	*menu = (menuDef_t *) item;
...
// NERVE - SMF
qboolean
MenuParse_execKey ( itemDef_t *item, int handle )
{
	menuDef_t	*menu = (menuDef_t *) item;
	char		keyname = 0;
	short int	keyindex;
...
/* */
qboolean
MenuParse_execKeyInt ( itemDef_t *item, int handle )
{
	menuDef_t	*menu = (menuDef_t *) item;
	int			keyname = 0;
...
// -NERVE - SMF
qboolean
MenuParse_drawAlwaysOnTop ( itemDef_t *item, int handle )
{
	menuDef_t	*menu = (menuDef_t *) item;
...
qboolean
MenuParse_itemHotkeyMode ( itemDef_t *item, int handle )
{
...
// TTimo
qboolean
MenuParse_modal ( itemDef_t *item, int handle )
{
	menuDef_t	*menu = (menuDef_t *) item;
...
*/
qboolean
PC_String_Parse_Trans ( int handle, const char **out )
{
	pc_token_t	token;
	if ( !trap_PC_ReadToken( handle, &token) )
	{
...
/* */
qboolean
BG_RectContainsPoint ( float x, float y, float w, float h, float px, float py )
{
...
/* */
qboolean
BG_CursorInRect ( rectDef_t *rect )
{
...
/* */
void
BG_PanelButton_RenderEdit ( panel_button_t *button )
{
	...
	if ( useCvar )
	{
		...
		DC->drawTextExt( button->rect.x, button->rect.y + button->rect.h, button->font->scalex, button->font->scaley,
						 button->font->colour, va( "^7%s", buffer + offset), 0, 0, button->font->style,
						 button->font->font );
	}
	else
	{
...
/* */
qboolean
BG_PanelButton_EditClick ( panel_button_t *button, int key )
{
	if ( key == K_MOUSE1 )
	{
...
/* */
qboolean
BG_PanelButtonsKeyEvent ( int key, qboolean down, panel_button_t **buttons )
{
...
/* */
void
BG_PanelButtonsSetup ( panel_button_t **buttons )
{
	panel_button_t	*button;
	for ( ; *buttons; buttons++ )
	{
...
/* */
panel_button_t *
BG_PanelButtonsGetHighlightButton ( panel_button_t **buttons )
{
	panel_button_t	*button;
	for ( ; *buttons; buttons++ )
	{
...
/* */
void
BG_PanelButtonsRender ( panel_button_t **buttons )
{
	panel_button_t	*button;
	for ( ; *buttons; buttons++ )
	{
...
/* */
void
BG_PanelButtonsRender_TextExt ( panel_button_t *button, const char *text )
{
	...
	DC->drawTextExt( x, button->rect.y + button->data[0], button->font->scalex, button->font->scaley,
					 button->font->colour, text, 0, 0, button->font->style, button->font->font );
}


/* */
void
BG_PanelButtonsRender_Text ( panel_button_t *button )
{
...
/* */
void
BG_PanelButtonsRender_Img ( panel_button_t *button )
{
...
/* */
panel_button_t *
BG_PanelButtons_GetFocusButton ( void )
{
...
/* */
void
BG_PanelButtons_SetFocusButton ( panel_button_t *button )
{
...
/* */
void
BG_FitTextToWidth_Ext ( char *instr, float scale, float w, int size, fontInfo_t *font )
{
	char	buffer[1024];
	char	*s, *p, *c, *ls;
	int		l;
